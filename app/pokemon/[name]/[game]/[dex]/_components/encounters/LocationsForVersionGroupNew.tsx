...
type LocationsForVersionGroupNewProps = {
 ...
 */
const LocationsForVersionGroupNew: React.FC<
  LocationsForVersionGroupNewProps
...
export default LocationsForVersionGroupNew;
